...
public class VRegEst extends javax.swing.JFrame {
    ...
    private void TablaRegistroMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaRegistroMouseClicked
        ...
        if (filaseleccionada >= 0) {
            ...
            // Obtenemos la fecha en formato String de la tabla
            String fechaString = modeloTabla.getValueAt(filaseleccionada, 3).toString();

            try {
                // Creamos un formato de fecha que coincida con el formato en la tabla (dd/MM/yyyy)
                SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
                // Convertimos el String a Date
                Date fecha = sdf.parse(fechaString);
                // Establecemos la fecha en el jDateChooser
                jDateChooser1.setDate(fecha);
            } catch (Exception e) {
                // Mostramos un mensaje si ocurre un error al convertir la fecha
